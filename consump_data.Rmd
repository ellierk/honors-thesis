...
```{r}
boxplot(squid$consump, ylab = "Consumption", main = "Distribution of Consumption")
boxplot((squid%>% filter(site == "mera"))$consump)
boxplot((squid%>% filter(site == "styron"))$consump)

boxplot(consump ~ dist_from_bags, xlab = "Distance from Bags (m)", ylab = "Consumption", main = "Distribution of Consumption by Distance", data = squid)
